...
function About() {
  return (
    <div class="container">
      <h1>About Us😊😊</h1>
      <p>At Pinch Of Salt, we're passionate about food and believe that everyone should have easy access to delicious and healthy meals. That's why we've created a user-friendly app that connects you with a wide range of restaurants, cafes, and food trucks in your area..</p>
      <h2>Our Team 😶‍🌫️😌</h2>
      <ul>
        <li>
          <strong></strong> Our team is made up of foodies, nutritionists, and tech experts who work together to bring you the best possible experience. We carefully curate our restaurant partners to ensure that they offer high-quality, fresh, and tasty food, and we're constantly updating our app to make it even easier to order and customize your meals.
          <ul>
